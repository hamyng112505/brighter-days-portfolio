...
import beaLoveStoryImage from '../attached_assets/photos/bea-love-story.jpg';
import maeganNateImage from '../attached_assets/photos/maegan-nate.jpg';
import nicoleMatthewImage from '../attached_assets/photos/nicole-matthew.jpg';
        ...
        <div className="mx-auto max-w-[1380px]">
          ...
          <div className="flex flex-col gap-7">
            <div className="grid gap-5 md:grid-cols-2 md:items-start md:gap-7">
              ...
              <a href="https://brighterdaystophoto.pixieset.com/beaslovestory/" target="_blank" rel="noreferrer" data-testid="button-story-coast" className="group block w-full border-0 bg-transparent p-0 text-left md:mt-16">
                <div className="relative aspect-[4/3] overflow-hidden bg-[#dad8d2]"><img src={beaLoveStoryImage} alt="Couple sharing a forehead kiss surrounded by autumn colour" className="image-lift h-full w-full object-cover" /><span className="absolute left-4 top-4 bg-[#232426] px-3 py-2 label text-[9px] uppercase tracking-[.16em] text-[#f6f4ef]">Toronto / Couple</span><span className="absolute bottom-5 right-5 flex h-11 w-11 items-center justify-center rounded-full bg-[#f6f4ef] text-[#232426] opacity-0 transition group-hover:opacity-100"><ArrowUpRight size={17} /></span></div>
                <div className="mt-4 flex justify-between gap-4 border-b border-[#d9d7d0] pb-4"><div><h3 className="serif text-[28px] leading-none text-[#232426]">Bea's Love Story</h3><p className="mt-2 text-xs text-[#8b8a84]">An autumn couple's session</p></div><span className="label pt-2 text-[10px] text-[#8b8a84]">02</span></div>
              </a>
            </div>
            <div className="grid gap-5 md:grid-cols-2 md:items-start md:gap-7">
              <a href="https://brighterdaystophoto.pixieset.com/maeganandnate/" target="_blank" rel="noreferrer" data-testid="button-story-window" className="group block w-full border-0 bg-transparent p-0 text-left">
                <div className="relative aspect-[4/3] overflow-hidden bg-[#dad8d2]"><img src={maeganNateImage} alt="Couple laughing together on a Toronto street" className="image-lift h-full w-full object-cover" /><span className="absolute left-4 top-4 bg-[#f6f4ef] px-3 py-2 label text-[9px] uppercase tracking-[.16em] text-[#232426]">Toronto / Engagement</span><span className="absolute bottom-5 right-5 flex h-11 w-11 items-center justify-center rounded-full bg-[#f6f4ef] text-[#232426] opacity-0 transition group-hover:opacity-100"><ArrowUpRight size={17} /></span></div>
                <div className="mt-4 flex justify-between gap-4 border-b border-[#d9d7d0] pb-4"><div><h3 className="serif text-[28px] leading-none text-[#232426]">Maegan &amp; Nate</h3><p className="mt-2 text-xs text-[#8b8a84]">A summer engagement session</p></div><span className="label pt-2 text-[10px] text-[#8b8a84]">03</span></div>
              </a>
              <a href="https://brighterdaystophoto.pixieset.com/nicoleandmatthew/" target="_blank" rel="noreferrer" data-testid="button-story-field" className="group block w-full border-0 bg-transparent p-0 text-left md:mt-16">
                <div className="relative aspect-[4/3] overflow-hidden bg-[#dad8d2]"><img src={nicoleMatthewImage} alt="Bride and groom smiling together at their wedding" className="image-lift h-full w-full object-cover" /><span className="absolute left-4 top-4 bg-[#232426] px-3 py-2 label text-[9px] uppercase tracking-[.16em] text-[#f6f4ef]">Toronto / Wedding</span><span className="absolute bottom-5 right-5 flex h-11 w-11 items-center justify-center rounded-full bg-[#f6f4ef] text-[#232426] opacity-0 transition group-hover:opacity-100"><ArrowUpRight size={17} /></span></div>
                <div className="mt-4 flex justify-between gap-4 border-b border-[#d9d7d0] pb-4"><div><h3 className="serif text-[28px] leading-none text-[#232426]">Nicole &amp; Matthew</h3><p className="mt-2 text-xs text-[#8b8a84]">A wedding day, captured</p></div><span className="label pt-2 text-[10px] text-[#8b8a84]">04</span></div>
              </a>
            </div>
          </div>
